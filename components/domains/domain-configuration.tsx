  ...
  return (
    <div className="pt-2">
      ...
      <DnsRecord
        ...
        warning={
          txtVerification
            ? "Warning: if you are using this domain for another site, setting this TXT record will transfer domain ownership away from that site and break it. Please exercise caution when setting this record; make sure that the domain that is shown in the TXT verification value is actually the <b><i>domain you want to use on Khaznah</i></b> – <b><i>not your production site</i></b>."
            : undefined
        }
      />
    </div>
