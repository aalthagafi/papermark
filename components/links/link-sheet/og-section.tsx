  ...
  return (
    <div className="pb-5">
      <LinkItem
        ...
        link="https://app.kaznah.com/help/article/change-social-media-cards"
          ...
          <div>
            ...
            <div className="relative mt-1 flex rounded-md shadow-sm">
              ...
              <Input
                ...
                placeholder={`Khaznah - open-source document sharing infrastructure.`}
                value={metaTitle || ""}
                onChange={(e) => {
          ...
          <div>
            ...
            <div className="relative mt-1 flex rounded-md shadow-sm">
              ...
              <Textarea
                ...
                maxLength={240}
                className="focus:ring-inset"
                placeholder={`Khaznah is an open-source document sharing infrastructure for modern teams.`}
