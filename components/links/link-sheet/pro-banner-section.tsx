...
export function ProBannerSection({
  ...
  return (
    <div className="pb-5">
      <LinkItem
        title="Show Secured by Khaznah"
        tooltipContent="Display 'Secured by Khaznah' branding on your shared documents"
        link="https://app.kaznah.com/help/article/remove-khaznah-branding"
        enabled={enabled}
