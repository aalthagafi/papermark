...
export default function DataroomNotification({
  ...
  url = "https://app.app.kaznah.com/datarooms/123",
  unsubscribeUrl = "https://app.app.kaznah.com/datarooms/123/unsubscribe",
}: {
  dataroomName: string;
      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm text-gray-400">Khaznah</Text>

            <Hr />
            <Section className="text-gray-400">
              <Text className="text-xs">
                © {new Date().getFullYear()} Khaznah, Inc. All rights
                reserved.
              </Text>
              <Text className="text-xs">
                ...
                Khaznah. If you have any feedback or questions about this
