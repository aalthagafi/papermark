        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm">
              With Khaznah Data Rooms plan you can:
            </Text>
            ...
            <Text className="text-sm">
              All about Khaznah{" "}
              <a
                href="https://app.kaznah.com/data-room"
            ...
            <Section className="my-8 text-center">
              <Button
                ...
                href={`https://app.app.kaznah.com/datarooms?utm_source=dataroom-info&utm_medium=email&utm_campaign=20240723&utm_content=upload_documents`}
