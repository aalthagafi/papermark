...
const SixMonthMilestoneEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>6 months with Khaznah</Preview>
      <Tailwind>
        <Body className="font-sans text-sm">
          <Text>Hi {name},</Text>
          <Text>What&apos;s been your biggest win using Khaznah?</Text>
          <Text>
            Marc here. It&apos;s been 6 months since you using advanced
            Khaznah features! Excited to hear your story and feedback for us.
          </Text>
