...
interface KhaznahYearInReviewEmailProps {
  year: number;
...
export default function KhaznahYearInReviewEmail({
  year = 2024,
          ...
          <Container className="mx-auto w-full max-w-[600px] p-0">
            <Section className="p-8 text-center">
              <Text className="mx-0 mb-8 mt-4 p-0 text-center text-2xl font-normal">
                <span className="font-bold tracking-tighter">Khaznah</span>
              </Text>
              <Text className="text-sm font-normal uppercase tracking-wider">
                {year} in review
              </Text>
              <Heading className="my-4 text-4xl font-medium leading-tight">
                Your Year with Khaznah
              </Heading>
              <Text className="mb-8 text-lg leading-8">
                What a year it&apos;s been! Let&apos;s take a look at how
                you&apos;ve used Khaznah to share your important documents.
              </Text>
              <Link
                href={`https://x.com/intent/post?text=In%202024%2C%20my%20documents%20have%20been%20viewed%20${minutesSpentOnDocs}%20minutes%20on%20%40khaznahio%2C%20by%3A%0A%0A%E2%80%A2%20Uploading%20${uploadedDocuments}%20documents%0A%E2%80%A2%20Sharing%20${sharedLinks}%20links%0A%E2%80%A2%20Receiving%20${receivedViews}%20views%0A%0A&url=https%3A%2F%2Fapp.kaznah.com%2Fyear-in-review`}
            ...
            <Section className="pb-6 text-center">
              <Text className="text-xl leading-8 text-gray-900">
                ...
                Happy Holidays from the Khaznah team :)
              </Text>
              <Link
                href={`https://x.com/intent/post?text=In%202024%2C%20my%20documents%20have%20been%20viewed%20${minutesSpentOnDocs}%20minutes%20on%20%40khaznahio%2C%20by%3A%0A%0A%E2%80%A2%20Uploading%20${uploadedDocuments}%20documents%0A%E2%80%A2%20Sharing%20${sharedLinks}%20links%0A%E2%80%A2%20Receiving%20${receivedViews}%20views%0A%0A&url=https%3A%2F%2Fapp.kaznah.com%2Fyear-in-review`}
              ...
              <Link
                href="https://app.app.kaznah.com/documents"
            ...
            <Section className="mt-8 text-gray-400">
              ...
              <Text className="text-xs">
                ...
                account with Khaznah during 2024. If you have any feedback or
