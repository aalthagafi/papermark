...
const DataroomTrial24hReminderEmail = ({ name }: TrialEndReminderEmail) => {
  return (
    <Html>
      <Head />
      <Preview>Upgrade to Khaznah Data Rooms Plan</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              Your Khaznah Data Room plan trial expires in 24 hours.
              Don&apos;t lose access to these features -{" "}
              <Link href={`https://app.app.kaznah.com/settings/billing`}>
                upgrade today
              </Link>
              :
            </Text>
            ...
            <Section className="mb-[32px] mt-[32px] text-center">
              <Button
                ...
                href={`https://app.app.kaznah.com/settings/billing`}
            ...
            <Text className="text-sm text-gray-400">Marc from Khaznah</Text>
            <Footer />
          </Container>
        </Body>
      </Tailwind>
