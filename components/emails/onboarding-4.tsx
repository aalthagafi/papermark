      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm">With Khaznah you can:</Text>
            <ul className="list-inside list-disc text-sm">
              <li>
                Share documnets with your <strong>custom domain💫</strong>{" "}
              </li>

              <li>Remove &quot;powered by Khaznah&quot;</li>
            ...
            <Section className="mb-[32px] mt-[32px] text-center">
              <Button
                ...
                href={`https://app.app.kaznah.com/documents?utm_source=onboarding&utm_medium=email&utm_campaign=20240723&utm_content=upload_documents`}
            ...
            <Text className="text-sm">
              ...
              <a
                href="https://cal.com/marcseitz/khaznah"
