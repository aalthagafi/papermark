...
export function Chat({
  ...
  useEffect(() => {
    if (error instanceof Error) {
      ...
      if (isPublic) {
        content =
          "You have reached your request limit for the day. Sign up for a free account to continue using Khaznah Assistant.";
      }
      if (userId && plan !== "pro") {
        content =
          "You have reached your request limit for the day. Upgrade to a paid account to continue using Khaznah Assistant.";
      }
