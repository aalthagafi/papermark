...
export default async function DomainMiddleware(req: NextRequest) {
  ...
  // If it's the root path, redirect to app.kaznah.com/home
  if (path === "/") {
    ...
    return NextResponse.redirect(
      new URL("https://app.kaznah.com/home", req.url),
    );
  }
  ...
  return NextResponse.rewrite(url, {
    headers: {
      ...
      "X-Powered-By":
        "Khaznah - Secure Data Room Infrastructure for the modern web",
    },
  });
}
