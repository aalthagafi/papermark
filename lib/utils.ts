...
export function constructMetadata({
  title = "Khaznah | The Open Source DocSend Alternative",
  description = "Khaznah is an open-source document sharing alternative to DocSend with built-in engagement analytics and 100% white-labeling.",
  image = "https://app.kaznah.com/_static/meta-image.png",
  favicon = "/favicon.ico",
  noIndex = false,
}: {
  title?: string;
