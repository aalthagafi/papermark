...
const baseUrl =
  process.env.NEXT_PUBLIC_MARKETING_URL || "https://app.kaznah.com";
        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-[40px] w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            <Section className="mt-[32px]">
              <Img
                src={`${baseUrl}/_static/khaznah-logo.png`}
                width="160"
                height="48"
                alt="Khaznah"
            ...
            <Section className="mt-[32px] border-t border-solid border-[#eaeaea] pt-[20px]">
              <Text className="text-[12px] leading-[16px] text-[#666]">
                ...
                team on Khaznah. If you believe this was sent in error, please
                contact our support team.
              </Text>

              <Text className="text-[12px] leading-[16px] text-[#666]">
                Khaznah - The secure document sharing platform
              </Text>
            </Section>
          </Container>
        </Body>
