...
export function FeedbackModal({
  ...
  const getSubtitle = () => {
    ...
    switch (reason) {
      ...
      case "unused":
        return "Help us understand how we can make Khaznah more valuable for your workflow.";
      case "missing_features":
  ...
  const getPlaceholder = () => {
    ...
    switch (reason) {
      ...
      case "unused":
        return "Share how you use Khaznah and what would make it more valuable...";
      case "missing_features":
