...
const data = {
  description: "Accept your team invitation on Khaznah",
  title: "Accept Invitation | Khaznah",
              ...
              {!isExpired && !isRevoked && (
                <>
                  <h3 className="text-balance py-1 text-sm font-normal text-gray-800">
                    You&apos;ve been invited to join a team on Khaznah
                  </h3>
                ...
                <div className="max-w-xl text-center">
                  <blockquote className="text-l text-balance leading-8 text-gray-100 sm:text-xl sm:leading-9">
                    <p>
                      ...
                      need. Thanks Khaznah team for solving a big pain point.
