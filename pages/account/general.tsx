    ...
    <AppLayout>
      <main className="relative mx-2 mb-10 mt-4 space-y-8 overflow-hidden px-1 sm:mx-3 md:mx-5 md:mt-5 lg:mx-7 lg:mt-8 xl:mx-10">
        ...
        <div className="space-y-6">
          <Form
            title="Your Name"
            description="This will be your display name on Khaznah."
            inputAttrs={{
              name: "name",
          ...
          <Form
            title="Your Email"
            description="This will be the email you use to log in to Khaznah and receive notification. A confirmation is required for changes."
            inputAttrs={{
              name: "email",
          ...
          <UploadAvatar
            title="Your Avatar"
            description="This is your avatar image on Khaznah."
